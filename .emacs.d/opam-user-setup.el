...
;; ## added by OPAM user-setup for emacs / tuareg ## d5ac555668fd8639c51548ced6c7651d ## you can edit, but keep this line
...
(defun opam-tuareg-autoload (fct file doc args)
  (let ((load-path (cons "/Users/takuro-n/.opam/default/share/emacs/site-lisp" load-path)))
    (load file))
  (apply fct args))
